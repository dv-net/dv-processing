...
import (
	...
	"github.com/dv-net/dv-processing/internal/services/processedincidents"
...
type IBaseServices interface { //nolint:interfacebloat
	...
	ProcessedIncidents() *processedincidents.Service
...
func New(
	...
	processedincidentsSvc := processedincidents.New(st)
	...
	return &service{
		...
		processedIncidents: processedincidentsSvc,
		wallets:            walletsSvc,
		system:             systemSvc,
...
func (s *service) ProcessedIncidents() *processedincidents.Service { return s.processedIncidents }
